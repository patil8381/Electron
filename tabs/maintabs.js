...
function createWindow() {
    win = new BrowserWindow({ 
        ...
        webPreferences:{
            ...
            preload: path.join(__dirname, 'indextabs.js'),
            contextIsolation:true,
            // or  path.join is only join the root file path and the preload.js 
            // preload: (__dirname + '/mainPreload.js'
        }
    });
...
function childWindow() {
    ...
    childWindow.loadFile('tabs.html');
}
...
//line above will close app when all windows closed
